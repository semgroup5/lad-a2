public class TestList {
    ...
    public static void testList(SortedList<String> xs){
        ...
        System.out.print(xs.firstIndex("A")  + " "); //0
        System.out.print(xs.firstIndex("Ab") + " "); //0
        System.out.print(xs.firstIndex("C")  + " "); //2
        System.out.print(xs.firstIndex("Cd") + " "); //2
        System.out.print(xs.firstIndex("De")  + " ");//4
        System.out.print(xs.firstIndex("E")  + " "); //5
        ...
        xs = new SortedListImpl<String>();
        String[] ss2 = {"A","A","A","A","A","A","A","A","A","A","A","A","A","A","A","A"};
        xs.addSortedArray(ss2);
